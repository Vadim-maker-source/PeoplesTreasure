...
const Mongoly = () => {
  ...
  return (
    <div className="w-full mt-8">
        <h1 className="text-3xl text-black dark:text-white font-semibold text-center mt-8">Монгольские народы</h1>
...
<div className="w-full md:px-15 px-5 py-10">
      ...
      <div className="flex flex-col md:px-15 px-5 gap-10 pb-15">
        <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full break-all rounded-lg">
            <p className="text-lg text-black">Монгольские народы России — это наследники великой степной империи, сохранившие уникальный синтез кочевой культуры и глубокой буддийской философии. Они живут на стыке степей, гор и тайги, что определяет их самобытный уклад.</p>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Два основных народа: буряты (~460 тыс.) и калмыки (~180 тыс.). Это коренные народы Сибири и Европейской России соответственно.</p>
            </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Монгольская ветвь алтайской языковой семьи. Языки близкородственны, бурятский и калмыцкий (ойратский) диалекты входят в общемонгольский языковой континуум и исторически взаимопонятны.</p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black"> Буряты: Республика Бурятия, Агинский Бурятский округ в Забайкальском крае, Иркутская область (Усть-Ордынский Бурятский округ). Калмыки: Республика Калмыкия — единственный регион в Европе, где монголоязычный народ и буддизм являются титульными.</p>
            </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Основаны на «трех столпах»: кочевом скотоводстве (конь, верблюд, овца), тибетском буддизме (ламаизм) школы Гелуг и древнем комплексе дошаманских и шаманских верований. Культ вежливости, степенного достоинства, почитания старших и духов местности (эжинов).</p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Кухня кочевников-скотоводов. Основа — мясо (баранина, конина, у бурят — также говядина), молочные продукты (кислые и сушеные). Национальные блюда: позы/буузы (большие пельмени на пару), ботого (суп с мясом и тестом), сушеный творог (аарса, хуруд), соленый чай с молоком и маслом (джа, сүүтэй цай), кумыс из кобыльего молока. Калмыцкий чай часто варят с солью, перцем и маслом.</p>
            </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Приспособлен для верховой езды и степного климата. Мужской: правозапашной халат (дэгэл, бииз) с высоким воротником, подпоясанный кушаком, шапка с ушами или остроконечная. Женский: халат-халат (дэгэл, цегдег) часто без пояса, с богатой отделкой парчой и серебром, сложные прически и украшения (серьги-«жоро», нагрудники). У калмычек — уникальные шапочки и шпильки для волос.</p>
            </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Бурятский и калмыцкий (ойратский) языки. Письменность: исторически — старомонгольское вертикальное письмо, в XVII веке калмыки и часть бурят приняли ясное письмо (тодо бичиг), созданное Зая-Пандитой. В советское время — латиница, затем кириллица. Сегодня в Бурятии и Калмыкии идет возрождение старомонгольской письменности.</p>
            </div>
        </div>
