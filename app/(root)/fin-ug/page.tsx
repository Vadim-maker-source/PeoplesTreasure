...
const FinUg = () => {
  ...
  return (
    <div className="w-full mt-8">
        <h1 className="text-3xl text-black dark:text-white font-semibold text-center mt-8">Финно-Угорские народы</h1>
      ...
      <div className="flex flex-col md:px-15 px-5 gap-10 pb-15">
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Крупнейшие: мордва (мокша и эрзя, ~700 тыс.), удмурты (~550 тыс.), марийцы (~500 тыс.), коми (~200 тыс.). Средние и малые: карелы (~40 тыс.), коми-пермяки (~55 тыс.), ханты (~31 тыс.), манси (~12 тыс.), вепсы (~6 тыс.), ижорцы, водь (сотни человек). Многие находятся на грани исчезновения.</p>
            </div>

            <div className="bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <img src="/images/fch.png" alt="" className=" w-full" />
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Уральская языковая семья, финно-угорская ветвь. Делится на группы: прибалтийско-финская (карелы, вепсы, ижорцы, водь), волжская (марийцы, мордва), пермская (коми, удмурты) и угорская (ханты, манси). Языки между группами не взаимопонятны.
                </p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Компактно в своих республиках: Мордовия, Марий Эл, Удмуртия, Республика Коми, Карелия. А также в автономиях: Ханты-Мансийский АО — Югра, Ямало-Ненецкий АО (ханты, манси). Рассеяны в Кировской, Нижегородской, Пермской, Ленинградской, Тверской областях.</p>
            </div>

            <div className="bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <img src="/images/finReg.png" alt="" className=" w-full" />
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Основаны на культе природы и почитании предков. Центральная идея — жизнь в равновесии с миром. Традиции скромности, неконфликтности, «тихого» упрямства. Сильна родовая и соседская взаимопомощь. Большую роль играли общинные сходы и советы старейшин.
                </p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Белоснежный (у многих народов) холст, богато украшенный вышивкой — главная визитная карточка. Вышивка (красный, черный, синий узор) — это не просто декор, а сакральный оберег, рассказывающий о мире. Женский: рубаха-туника, передник, пояс-оберег, сложный головной убор (сорока, тастар, айшон), нагрудные украшения. Мужской: холщовая рубаха, штаны, кафтан-зипун.
                </p>
            </div>

            <div className="bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <img src="/images/finSuit.jpg" alt="" className="rounded-lg w-full" />
            </div>
        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="px-3 py-2 bg-[#FFF0F0] md:w-[60%] w-full rounded-lg">
                <p className="text-lg text-black">Восходят к древней уральской общности, предположительно сформировавшейся в районе Урала или Западной Сибири. Их предки начали расселяться на запад и юг несколько тысячелетий назад, ассимилируя древнейшее население и вступая в контакты с индо-ираноязычными, а затем тюркскими и славянскими племенами. Являются автохтонным (коренным) населением своих территорий.</p>
            </div>
        </div>
